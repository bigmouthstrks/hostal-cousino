			...
			<form method="POST" action={{ route('habitaciones.store') }} enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-around row">
                    <div class="form-group col-4">
                        ...
                        <input type="number" class="form-control @error('cant_camas') is-invalid @enderror" id="cant_camas" name="cant_camas" placeholder="Nº de camas" value="{{ old('cant_camas') }}">
                    </div>
                    <div class="col-4">
                        ...
                        <div class="input-group mb-2">
                          ...
                          <input type="number" class="form-control @error('precio_noche') is-invalid @enderror  " id="precio_noche" name="precio_noche" placeholder="Precio" value="{{ old('precio_noche') }}">
                        </div>
                      </div>
                    <div class="form-group col-4">
                        <label for="numero">Número:</label>
                        <input type="number" class="form-control @error('numero') is-invalid @enderror" id="numero" name="numero" placeholder="Número" value="{{ old('numero') }}">
                    </div>
                </div>
				<div class="form-group">
